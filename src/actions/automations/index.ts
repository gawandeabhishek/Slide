...
export const saveListener = async (
  ...
  try {
    ...
    return { status: 404, data: "Cant save the listener" };
  } catch (error) {
...
export const saveKeyword = async (automationId: string, keyword: string) => {
  ...
  try {
    ...
    if (create) return { sțatus: 200, data: "Keyword addded successfully" };
...
export const deleteKeyword = async (id: string) => {
  ...
  try {
    ...
    if (create) return { sțatus: 200, data: "Keyword deleted" };
...
export const activateAutomation = async (id: string, state: boolean) => {
  ...
  try {
    ...
    if (update) {
      return { status: 200, data: `Automation ${state ? 'activated' : 'disabled'}` };
    }
    return { status: 404, data: "Automation not found" };
  } catch (error) {
    return { status: 500, data: 'Oops! something went wrong'}
